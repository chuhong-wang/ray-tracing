...
class Dielectric: public Material {
    ...
    public:
        Dielectric(double t_refractive_idx): refractive_idx(t_refractive_idx) {}
        bool scatter(const Ray<double>& ray_in, HitRecord& rec, Color<double>& t_attenuation, Ray<double>& ray_scattered) const {
            t_attenuation = Color<double>(1,1,1);
