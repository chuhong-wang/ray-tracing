...
Dielectric::Dielectric(float t_refractive_idx): refractive_idx(t_refractive_idx) {}

bool Dielectric::scatter(const Ray& ray_in, HitRecord& rec, Color& t_attenuation, Ray& ray_scattered) const {
